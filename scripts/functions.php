<?php
    ...
    function mk_password_hash_from_microtime(){
     ...
     function is_autorized($rollen)
     {
        if(!isset($_SESSION["id"]))
        {
           return header("Location: ./index.php?content=message&alert=autoriteit-error");
        }
       elseif(!in_array($_SESSION["rollen"],$rollen))
       {
           return header("Location: ./index.php?content=message&alert=autoriteit-error-rollen");
       }
       else
       {
          return true;
